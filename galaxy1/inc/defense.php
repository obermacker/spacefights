...
<span id="varTransfer" quantityOfConstructions="<?php echo (get_defense_count()); ?>" />
...
<form action="index.php" method="post" autocomplete="off" class="constructionGUI2">
	...
	<table id="default" cellspacing="0" cellpadding="0" class="übersicht" width=100%>
		<tr>
			...
			<th class="tbtb " colspan=5 style="text-align: center;"><?php lng_echo('required resoures'); ?></th>
					...
					if ($max_quantity || !$can_be_built) {$classStr = 'passive';}
						...
						<tr>
							...
							<?php } else { ?>
								...
								<td class="tbchell tbSechsStellig <?php echo $classStr . ' ' . $colorI; ?>" align="right">
									<span  id="resI<?php echo $i; ?>" rateForOneItem="<?php echo $construction['required iron']; ?>"> 
										<?php echo number_format($construction['required iron'], 0, '.', '.'); ?>
									</span>
									<img src="img/eisen.png" class="img_ress">
								 </td>
								<td class="tbchell tbSechsStellig <?php echo $classStr . ' ' . $colorS; ?>" align="right">
									<span  id="resS<?php echo $i; ?>" rateForOneItem="<?php echo $construction['required silicon']; ?>">
										<?php echo number_format($construction['required silicon'], 0, '.', '.'); ?>
									</span>
									<img src="img/silizium.png" class="img_ress"> 
								</td>
								<td class="tbchell tbSechsStellig <?php echo $classStr . ' ' . $colorW; ?>" align="right">
									<span  id="resW<?php echo $i; ?>" rateForOneItem="<?php echo $construction['required water']; ?>">
										<?php echo number_format($construction['required water'], 0, '.', '.'); ?>
									</span>
									<img src="img/wasser.png" class="img_ress"> 
								</td>
								<td width=1% class="tbchell tbVierStellig <?php echo $classStr . ' ' . $colorB; ?>" align="right">
									<span  id="resB<?php echo $i; ?>" rateForOneItem="<?php echo $construction['required bots']; ?>">
										<?php echo number_format($construction['required bots'], 0, '.', '.'); ?>
									</span>
									<img src="img/bot.png" class="img_ress"> 
								</td>
								<td width=1% class="tbchell tbVierStellig <?php echo $classStr . ' ' . $colorK; ?>" align="right">
									<span  id="resK<?php echo $i; ?>" rateForOneItem="<?php echo $construction['required karma']; ?>">
										<?php echo number_format($construction['required karma'], 0, '.', '.'); ?>
									</span>						
								...
								<td width=1% class="tbchell tbConstructionTime <?php echo $classStr; ?> " >
									<span  id="constructionTime<?php echo $i; ?>" rateForOneItem="<?php echo $construction['construction time']; ?>">
										<?php echo get_timestamp_in_was_sinnvolles($construction['construction time']); ?>
									</span>
								</td>
							<?php } ?>
						</tr>
												...
												<table id="default" class="tbBeschreibungLangText">
													<tbody>
														...
														<tr>
															<td >
																<ul class="ress">
																	<li class="<?php echo $colorB; ?>"><img src="img/bots.png" class="img_ress"> <?php echo number_format($construction['required bots'], 0, '.', '.'); ?></li>
																	<li class="<?php echo $colorI; ?>"><img src="img/iron.png" class="img_ress"> <?php echo number_format($construction['required iron'], 0, '.', '.'); ?></li>
																	<li class="<?php echo $colorS; ?>"><img src="img/silicon.png" class="img_ress"> <?php echo number_format($construction['required silicon'], 0, '.', '.'); ?></li>
																	<li class="<?php echo $colorW; ?>"><img src="img/water.png" class="img_ress"> <?php echo number_format($construction['required water'], 0, '.', '.'); ?></li>
																	<li class="<?php echo $colorK; ?>"><img src="img/karma.png" class="img_ress"> <?php echo number_format($construction['required karma'], 0, '.', '.'); ?></li>
																</ul>
															</td>
														</tr>
														<tr>
															<td class="tbchell">
																<ul class="nav inline-items-attr">
																	<li><font style="font-size: x-small;"><?php lng_echo('attack'); ?></font><?php echo number_format($construction['attack strength'], 0, '.', '.'); ?></li>
																	<li><font style="font-size: x-small;"><?php lng_echo('defense'); ?></font><?php echo number_format($construction['defense strength'], 0, '.', '.'); ?></li>
																	<!-- 
			...
			<tr>
				...
				<td colspan=10> 
					<table cellspacing="0" cellpadding="0" class="" width=100%>
						<tbody>
							<tr>
								<td class="tbtb"><?php lng_echo('total building time / costs'); ?></td>
								...
								<td width=1% class="tbtb tbConstructionTime">
