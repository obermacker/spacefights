...
// quick and dirty : alle Spieler berechnen ;-)
$alle_Spieler = false;

if ($alle_Spieler) {
	require 'inc/connect_galaxy_1.php';
	$query = "SELECT `Spieler_ID` FROM `spieler`";
...
while ($weiter){
	...
	echo "<h4> -> " . get_spieler_name($spieler_id) . " <- ... Gebäude: " . $punkte_neu["Gebäude"] . " ... Flotte: " . $punkte_neu["Flotte"] . " ... Forschung: " . $punkte_neu["Forschung"] ." ... ";
